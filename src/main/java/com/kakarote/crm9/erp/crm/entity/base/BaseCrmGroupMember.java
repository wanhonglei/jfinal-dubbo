...
public abstract class BaseCrmGroupMember<M extends BaseCrmGroupMember<M>> extends CrmModel<M> implements IBean {
	...
	public M setOwnerFlag(Integer ownerFlag) {
		set("owner_flag", ownerFlag);
		return (M)this;
	}
	
	public Integer getOwnerFlag() {
		return getInt("owner_flag");
	}

	public M setPower(Integer power) {
		set("power", power);
		return (M)this;
	}
