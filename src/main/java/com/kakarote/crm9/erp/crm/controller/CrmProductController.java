...
public class CrmProductController extends Controller {
    ...
    public void saveAndUpdate() {
        ...
        renderJson(crmProductService.saveAndUpdate(jsonObject, BaseUtil.getUserId()));
    }
    ...
    public void downloadExcel(){
        ...
        try {
            ...
            try{
                ...
                logger.error(String.format("downloadExcel product msg:%s",BaseUtil.getExceptionStack(e)));
            }
        }
        renderNull();
    }
    ...
    public void uploadExcel(@Para("file") UploadFile file, @Para("repeatHandling") Integer repeatHandling, @Para("ownerUserId") Integer ownerUserId){
        renderJson(crmProductService.uploadExcel(file,repeatHandling,ownerUserId,BaseUtil.getUserId()));
    }
    /**
     * @author zxy
     * 获取上架商品
