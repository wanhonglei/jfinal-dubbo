...
public abstract class BaseAdminScene<M extends BaseAdminScene<M>> extends CrmModel<M> implements IBean {

	public M setSceneId(Long sceneId) {
		set("scene_id", sceneId);
		return (M)this;
	}

	public Long getSceneId() {
		return getLong("scene_id");
	}
