...
/**
 * @Author: haihong.wu
 * @Date: 2020/6/17 9:58 上午
 */
public class Assert {

    /**
     * 断言是否为真，如果为 {@code false} 抛出 {@code CrmException} 异常<br>
     *
     * <pre class="code">
    ...
    public static void isTrue(boolean expression, String errorMsgTemplate, Object... params) {
        if (!expression) {
            throw new CrmException(StrUtil.format(errorMsgTemplate, params));
        }
    }
    ...
    /**
     * 断言是否为假，如果为 {@code true} 抛出 {@code CrmException} 异常<br>
     *
     * <pre class="code">
    ...
    /**
     * 断言对象是否为{@code null} ，如果不为{@code null} 抛出{@link CrmException} 异常
     *
     * <pre class="code">
    ...
    /**
     * 断言对象是否不为{@code null} ，如果为{@code null} 抛出{@link CrmException} 异常 Assert that an object is not {@code null} .
     *
     * <pre class="code">
    ...
    /**
     * 断言对象是否不为{@code null} ，如果为{@code null} 抛出{@link CrmException} 异常
     *
     * <pre class="code">
    ...
    /**
     * 检查给定字符串是否为空，为空抛出 {@link CrmException}
     *
     * <pre class="code">
    ...
    /**
     * 检查给定字符串是否为空白（null、空串或只包含空白符），为空抛出 {@link CrmException}
     *
     * <pre class="code">
     ...
     * @since 4.1.9
     */
    public static int checkIndex(int index, int size, String errorMsgTemplate, Object... params) throws IndexOutOfBoundsException {
    ...
    public static int checkBetween(int value, int min, int max) {
        if (value < min || value > max) {
            throw new CrmException(StrUtil.format("Length must be between {} and {}.", min, max));
        }
        return value;
    }
    ...
    private static String badIndexMsg(int index, int size, String desc, Object... params) {
        if (index < 0) {
            ...
            throw new CrmException("negative size: " + size);
        } else { // index >= size
